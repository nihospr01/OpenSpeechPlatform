...
-- ldbanno -n VHDL -o test_arun_impl1_mapvho.vho -w -neg -gui -msgset /home/hari/Documents/osp-wearable-fpga/test_ramp/promote.xml test_arun_impl1_map.ncd 
-- Netlist created on Thu Mar 14 14:57:51 2019
-- Netlist written on Thu Mar 14 14:57:52 2019
...
-- entity SLICE_2
  ...
  begin
    rampcounter_10: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    rampcounter_9: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    un1_rampcounter_cry_9_0: ccu20002
...
-- entity SLICE_3
  ...
  begin
    rampcounter_8: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    rampcounter_7: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    un1_rampcounter_cry_7_0: ccu20002
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_4
  ...
  begin
    rampcounter_6: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    rampcounter_5: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    un1_rampcounter_cry_5_0: ccu20002
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_5
  ...
  begin
    rampcounter_4: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    rampcounter_3: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    un1_rampcounter_cry_3_0: ccu20002
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_6
  ...
  begin
    rampcounter_2: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    rampcounter_1: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    un1_rampcounter_cry_1_0: ccu20002
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity SLICE_7
  ...
  begin
    rampcounter_0: vmuxregsre0001
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    un1_rampcounter_cry_0_0: ccu20002
...
-- entity SLICE_8
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    counter_13: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    counter_cry_0_13: ccu20003
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>open);
...
-- entity SLICE_9
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    counter_11: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    counter_cry_0_11: ccu20002
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
...
-- entity SLICE_10
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    counter_9: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    counter_cry_0_9: ccu20002
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
...
-- entity SLICE_11
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    counter_7: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    counter_cry_0_7: ccu20002
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
...
-- entity SLICE_12
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    counter_5: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    counter_cry_0_5: ccu20002
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
...
-- entity SLICE_13
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    counter_3: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    counter_cry_0_3: ccu20002
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
...
-- entity SLICE_14
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    counter_1: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    counter_cry_0_1: ccu20002
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
...
-- entity SLICE_17
  ...
  begin
    counter3_RNO_1: lut40005
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    counter3_RNO_0: lut4
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    counter3_1: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    counter3_0: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_19
  ...
  begin
    un2_spi_data_11: lut40008
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    spi_data_1_11: lut40009
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    spi_data: vmuxregsre
...
-- entity spi_data_1_3_SLICE_20
  library IEEE, vital2000, MACHXO3L;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO3L.COMPONENTS.ALL;

  entity spi_data_1_3_SLICE_20 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "spi_data_1_3_SLICE_20";
    ...
    ATTRIBUTE Vital_Level0 OF spi_data_1_3_SLICE_20 : ENTITY IS TRUE;

  end spi_data_1_3_SLICE_20;

  architecture Structure of spi_data_1_3_SLICE_20 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    signal GNDI: Std_logic;
    signal spi_data_1_3_SLICE_20_spi_data_1_3_SLICE_20_K1_H1: Std_logic;
    signal spi_data_1_3_SLICE_20_spi_data_1_3_GATE_H0: Std_logic;
    component gnd
      port (PWR0: out Std_logic);
    end component;
    component lut40010
  ...
  begin
    spi_data_1_3_SLICE_20_K1: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, 
                Z=>spi_data_1_3_SLICE_20_spi_data_1_3_SLICE_20_K1_H1);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    spi_data_1_3_GATE: lut40010
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, 
                Z=>spi_data_1_3_SLICE_20_spi_data_1_3_GATE_H0);
    spi_data_1_3_SLICE_20_K0K1MUX: selmux2
      port map (D0=>spi_data_1_3_SLICE_20_spi_data_1_3_GATE_H0, 
                D1=>spi_data_1_3_SLICE_20_spi_data_1_3_SLICE_20_K1_H1, 
...
-- entity spi_data_1_10_SLICE_21
  library IEEE, vital2000, MACHXO3L;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO3L.COMPONENTS.ALL;

  entity spi_data_1_10_SLICE_21 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "spi_data_1_10_SLICE_21";
    ...
    ATTRIBUTE Vital_Level0 OF spi_data_1_10_SLICE_21 : ENTITY IS TRUE;

  end spi_data_1_10_SLICE_21;

  architecture Structure of spi_data_1_10_SLICE_21 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    signal GNDI: Std_logic;
    signal spi_data_1_10_SLICE_21_spi_data_1_10_SLICE_21_K1_H1: Std_logic;
    signal spi_data_1_10_SLICE_21_spi_data_1_10_GATE_H0: Std_logic;
    component gnd
      port (PWR0: out Std_logic);
    end component;
    component lut40010
  ...
  begin
    spi_data_1_10_SLICE_21_K1: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, 
                Z=>spi_data_1_10_SLICE_21_spi_data_1_10_SLICE_21_K1_H1);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    spi_data_1_10_GATE: lut40010
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, 
                Z=>spi_data_1_10_SLICE_21_spi_data_1_10_GATE_H0);
    spi_data_1_10_SLICE_21_K0K1MUX: selmux2
      port map (D0=>spi_data_1_10_SLICE_21_spi_data_1_10_GATE_H0, 
                D1=>spi_data_1_10_SLICE_21_spi_data_1_10_SLICE_21_K1_H1, 
                SD=>M0_ipd, Z=>OFX0_out);
...
-- entity spi_data_1_6_SLICE_22
  library IEEE, vital2000, MACHXO3L;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO3L.COMPONENTS.ALL;

  entity spi_data_1_6_SLICE_22 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "spi_data_1_6_SLICE_22";
    ...
    ATTRIBUTE Vital_Level0 OF spi_data_1_6_SLICE_22 : ENTITY IS TRUE;

  end spi_data_1_6_SLICE_22;

  architecture Structure of spi_data_1_6_SLICE_22 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    signal GNDI: Std_logic;
    signal spi_data_1_6_SLICE_22_spi_data_1_6_SLICE_22_K1_H1: Std_logic;
    signal spi_data_1_6_SLICE_22_spi_data_1_6_GATE_H0: Std_logic;
    component gnd
      port (PWR0: out Std_logic);
    end component;
    component lut40010
  ...
  begin
    spi_data_1_6_SLICE_22_K1: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, 
                Z=>spi_data_1_6_SLICE_22_spi_data_1_6_SLICE_22_K1_H1);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    spi_data_1_6_GATE: lut40010
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, 
                Z=>spi_data_1_6_SLICE_22_spi_data_1_6_GATE_H0);
    spi_data_1_6_SLICE_22_K0K1MUX: selmux2
      port map (D0=>spi_data_1_6_SLICE_22_spi_data_1_6_GATE_H0, 
                D1=>spi_data_1_6_SLICE_22_spi_data_1_6_SLICE_22_K1_H1, 
                SD=>M0_ipd, Z=>OFX0_out);
    spi_data_1_6_SLICE_22_FXMUX: selmux2
...
-- entity SLICE_23
  ...
  begin
    un7_rampcounter_8: lut40011
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    un7_rampcounter: lut40012
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity SLICE_24
  ...
  begin
    un7_rampcounter_6: lut40011
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    un7_rampcounter_7: lut40011
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity clockB
  ...
  entity clockB is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "clockB";

      tipd_clockS  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_clockS_PADDI	 : VitalDelayType01 := (0 ns, 0 ns);
      tperiod_clockS 	: VitalDelayType := 0 ns;
      tpw_clockS_posedge	: VitalDelayType := 0 ns;
      tpw_clockS_negedge	: VitalDelayType := 0 ns);

    port (PADDI: out Std_logic; clockS: in Std_logic);

    ATTRIBUTE Vital_Level0 OF clockB : ENTITY IS TRUE;

  end clockB;

  architecture Structure of clockB is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDI_out 	: std_logic := 'X';
    signal clockS_ipd 	: std_logic := 'X';

    component xo2iobuf0014
      port (Z: out Std_logic; PAD: in Std_logic);
    end component;
  begin
    clock_pad: xo2iobuf0014
      port map (Z=>PADDI_out, PAD=>clockS_ipd);

    --  INPUT PATH DELAYs
    WireDelay : BLOCK
    BEGIN
      VitalWireDelay(clockS_ipd, clockS, tipd_clockS);
    END BLOCK;

    VitalBehavior : PROCESS (PADDI_out, clockS_ipd)
    VARIABLE PADDI_zd         	: std_logic := 'X';
    VARIABLE PADDI_GlitchData 	: VitalGlitchDataType;

    VARIABLE tviol_clockS_clockS          	: x01 := '0';
    VARIABLE periodcheckinfo_clockS	: VitalPeriodDataType;

    BEGIN

    IF (TimingChecksOn) THEN
      VitalPeriodPulseCheck (
        TestSignal => clockS_ipd,
        TestSignalName => "clockS",
        Period => tperiod_clockS,
        PulseWidthHigh => tpw_clockS_posedge,
        PulseWidthLow => tpw_clockS_negedge,
        PeriodData => periodcheckinfo_clockS,
        Violation => tviol_clockS_clockS,
        MsgOn => MsgOn, XOn => XOn,
        HeaderMsg => InstancePath,
        CheckEnabled => TRUE,
        MsgSeverity => warning);
    ...
    VitalPathDelay01 (
      ...
      Paths      => (0 => (InputChangeTime => clockS_ipd'last_event,
                           PathDelay => tpd_clockS_PADDI,
                           PathCondition => TRUE)),
...
-- entity interruptB
  ...
  entity interruptB is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "interruptB";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_interruptS	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; interruptS: out Std_logic);

    ATTRIBUTE Vital_Level0 OF interruptB : ENTITY IS TRUE;

  end interruptB;

  architecture Structure of interruptB is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal interruptS_out 	: std_logic := 'X';

    component xo2iobuf0015
      port (I: in Std_logic; PAD: out Std_logic);
    end component;
  begin
    interrupt_pad: xo2iobuf0015
      port map (I=>PADDO_ipd, PAD=>interruptS_out);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, interruptS_out)
    VARIABLE interruptS_zd         	: std_logic := 'X';
    VARIABLE interruptS_GlitchData 	: VitalGlitchDataType;
    ...
    interruptS_zd 	:= interruptS_out;

    VitalPathDelay01 (

        OutSignal => interruptS, OutSignalName => "interruptS", OutTemp => interruptS_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_interruptS,
                           PathCondition => TRUE)),
      GlitchData => interruptS_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity xo2iobuf0016
  ...
  entity xo2iobuf0016 is
    port (I: in Std_logic; PAD: out Std_logic);

    ATTRIBUTE Vital_Level0 OF xo2iobuf0016 : ENTITY IS TRUE;

  end xo2iobuf0016;

  architecture Structure of xo2iobuf0016 is
  begin
    INST5: OB
      port map (I=>I, O=>PAD);
  end Structure;
...
-- entity adc_pdwnB
  ...
  architecture Structure of adc_pdwnB is
    ...
    component xo2iobuf0016
      port (I: in Std_logic; PAD: out Std_logic);
    end component;
  begin
    adc_pdwn_pad: xo2iobuf0016
...
-- entity adc_clk_copy2B
  library IEEE, vital2000, MACHXO3L;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO3L.COMPONENTS.ALL;

  entity adc_clk_copy2B is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "adc_clk_copy2B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_adcclkcopy2	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; adcclkcopy2: out Std_logic);

    ATTRIBUTE Vital_Level0 OF adc_clk_copy2B : ENTITY IS TRUE;

  end adc_clk_copy2B;

  architecture Structure of adc_clk_copy2B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal adcclkcopy2_out 	: std_logic := 'X';

    component xo2iobuf0016
      port (I: in Std_logic; PAD: out Std_logic);
    end component;
  begin
    adc_clk_copy2_pad: xo2iobuf0016
      port map (I=>PADDO_ipd, PAD=>adcclkcopy2_out);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, adcclkcopy2_out)
    VARIABLE adcclkcopy2_zd         	: std_logic := 'X';
    VARIABLE adcclkcopy2_GlitchData 	: VitalGlitchDataType;
    ...
    adcclkcopy2_zd 	:= adcclkcopy2_out;

    VitalPathDelay01 (

        OutSignal => adcclkcopy2, OutSignalName => "adcclkcopy2", OutTemp => adcclkcopy2_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_adcclkcopy2,
                           PathCondition => TRUE)),
      GlitchData => adcclkcopy2_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity adc_clk_copyB
  library IEEE, vital2000, MACHXO3L;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO3L.COMPONENTS.ALL;

  entity adc_clk_copyB is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "adc_clk_copyB";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_adcclkcopy	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; adcclkcopy: out Std_logic);

    ATTRIBUTE Vital_Level0 OF adc_clk_copyB : ENTITY IS TRUE;

  end adc_clk_copyB;

  architecture Structure of adc_clk_copyB is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal adcclkcopy_out 	: std_logic := 'X';

    component xo2iobuf0016
      port (I: in Std_logic; PAD: out Std_logic);
    end component;
  begin
    adc_clk_copy_pad: xo2iobuf0016
      port map (I=>PADDO_ipd, PAD=>adcclkcopy_out);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, adcclkcopy_out)
    VARIABLE adcclkcopy_zd         	: std_logic := 'X';
    VARIABLE adcclkcopy_GlitchData 	: VitalGlitchDataType;
    ...
    adcclkcopy_zd 	:= adcclkcopy_out;

    VitalPathDelay01 (

        OutSignal => adcclkcopy, OutSignalName => "adcclkcopy", OutTemp => adcclkcopy_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_adcclkcopy,
                           PathCondition => TRUE)),
      GlitchData => adcclkcopy_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity spi_misoB
  ...
  entity spi_misoB is
    ...
    GENERIC (
      ...
      tpd_IOLDO_spimiso	 : VitalDelayType01 := (0 ns, 0 ns));

    port (IOLDO: in Std_logic; spimiso: out Std_logic);
  ...
  begin
    spi_miso_pad: xo2iobuf0015
      port map (I=>IOLDO_ipd, PAD=>spimiso_out);
    ...
    VitalBehavior : PROCESS (IOLDO_ipd, spimiso_out)
...
-- entity spi_miso_MGIOL
  library IEEE, vital2000, MACHXO3L;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO3L.COMPONENTS.ALL;

  entity spi_miso_MGIOL is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "spi_miso_MGIOL";
    ...
    ATTRIBUTE Vital_Level0 OF spi_miso_MGIOL : ENTITY IS TRUE;

  end spi_miso_MGIOL;

  architecture Structure of spi_miso_MGIOL is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
...
-- entity spi_clkB
  ...
  entity spi_clkB is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "spi_clkB";

      tipd_spiclk  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_spiclk_PADDI	 : VitalDelayType01 := (0 ns, 0 ns);
      tperiod_spiclk 	: VitalDelayType := 0 ns;
      tpw_spiclk_posedge	: VitalDelayType := 0 ns;
      tpw_spiclk_negedge	: VitalDelayType := 0 ns);

    port (PADDI: out Std_logic; spiclk: in Std_logic);

    ATTRIBUTE Vital_Level0 OF spi_clkB : ENTITY IS TRUE;

  end spi_clkB;

  architecture Structure of spi_clkB is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDI_out 	: std_logic := 'X';
    signal spiclk_ipd 	: std_logic := 'X';

    component xo2iobuf0017
      port (Z: out Std_logic; PAD: in Std_logic);
    end component;
  begin
    spi_clk_pad: xo2iobuf0017
      port map (Z=>PADDI_out, PAD=>spiclk_ipd);

    --  INPUT PATH DELAYs
    WireDelay : BLOCK
    BEGIN
      VitalWireDelay(spiclk_ipd, spiclk, tipd_spiclk);
    END BLOCK;

    VitalBehavior : PROCESS (PADDI_out, spiclk_ipd)
    VARIABLE PADDI_zd         	: std_logic := 'X';
    VARIABLE PADDI_GlitchData 	: VitalGlitchDataType;

    VARIABLE tviol_spiclk_spiclk          	: x01 := '0';
    VARIABLE periodcheckinfo_spiclk	: VitalPeriodDataType;

    BEGIN

    IF (TimingChecksOn) THEN
      VitalPeriodPulseCheck (
        TestSignal => spiclk_ipd,
        TestSignalName => "spiclk",
        Period => tperiod_spiclk,
        PulseWidthHigh => tpw_spiclk_posedge,
        PulseWidthLow => tpw_spiclk_negedge,
        PeriodData => periodcheckinfo_spiclk,
        Violation => tviol_spiclk_spiclk,
        MsgOn => MsgOn, XOn => XOn,
        HeaderMsg => InstancePath,
        CheckEnabled => TRUE,
        MsgSeverity => warning);
    ...
    VitalPathDelay01 (
      OutSignal => PADDI, OutSignalName => "PADDI", OutTemp => PADDI_zd,
      Paths      => (0 => (InputChangeTime => spiclk_ipd'last_event,
                           PathDelay => tpd_spiclk_PADDI,
                           PathCondition => TRUE)),
      GlitchData => PADDI_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity EHXPLLJB
  ...
  begin
    INST10: EHXPLLJ
      generic map (CLKFB_DIV => 1, CLKI_DIV => 1, CLKOP_CPHASE => 7, 
                   CLKOP_DIV => 8, CLKOP_ENABLE => "ENABLED", 
                   ...
                   VCO_BYPASS_A0 => "ENABLED", VCO_BYPASS_B0 => "DISABLED", 
...
-- entity pll1_PLLInst_0
  library IEEE, vital2000, MACHXO3L;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO3L.COMPONENTS.ALL;

  entity pll1_PLLInst_0 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "pll1_PLLInst_0";
    ...
    port (CLKI: in Std_logic; CLKFB: in Std_logic; CLKINTFB: out Std_logic; 
          CLKOP: out Std_logic);
  ...
  architecture Structure of pll1_PLLInst_0 is
  ...
  begin
    pll1_PLLInst_0_EHXPLLJ: EHXPLLJB
      port map (CLKI=>CLKI_ipd, CLKFB=>CLKFB_ipd, PHASESEL1=>GNDI, 
                ...
                LOCK=>open, INTLOCK=>open, REFCLK=>open, 
    ...
    VitalBehavior : PROCESS (CLKI_ipd, CLKFB_ipd, CLKINTFB_out, CLKOP_out)
...
-- entity test_togglepins
  ...
  entity test_togglepins is
    port (clock: in Std_logic; xtal_in: in Std_logic; xtal_out: out Std_logic; 
          spi_clk: in Std_logic; spi_mosi: in Std_logic; spi_cs: in Std_logic; 
          spi_miso: out Std_logic; adc_clk: out Std_logic; 
          adc_clk_copy: out Std_logic; adc_clk_copy2: out Std_logic; 
          adc_pdwn: out Std_logic; adc_data: in Std_logic_vector (11 downto 0); 
  ...
  architecture Structure of test_togglepins is
    signal counter_0: Std_logic;
    signal counter_s_0: Std_logic;
    signal clock_c: Std_logic;
    signal counter_cry_0: Std_logic;
    signal rampcounter_11: Std_logic;
    signal un1_rampcounter_12: Std_logic;
    signal un7_rampcounter: Std_logic;
    signal spi_clk_c: Std_logic;
    signal un1_rampcounter_cry_10: Std_logic;
    signal rampcounter_10: Std_logic;
    signal rampcounter_9: Std_logic;
    signal un1_rampcounter_11: Std_logic;
    signal un1_rampcounter_10: Std_logic;
    signal un1_rampcounter_cry_8: Std_logic;
    signal rampcounter_8: Std_logic;
    signal rampcounter_7: Std_logic;
    signal un1_rampcounter_9: Std_logic;
    signal un1_rampcounter_8: Std_logic;
    signal un1_rampcounter_cry_6: Std_logic;
    signal rampcounter_6: Std_logic;
    signal rampcounter_5: Std_logic;
    signal un1_rampcounter_7: Std_logic;
    signal un1_rampcounter_6: Std_logic;
    signal un1_rampcounter_cry_4: Std_logic;
    signal rampcounter_4: Std_logic;
    signal rampcounter_3: Std_logic;
    signal un1_rampcounter_5: Std_logic;
    signal un1_rampcounter_4: Std_logic;
    signal un1_rampcounter_cry_2: Std_logic;
    signal rampcounter_2: Std_logic;
    signal rampcounter_1: Std_logic;
    signal un1_rampcounter_3: Std_logic;
    signal un1_rampcounter_2: Std_logic;
    signal un1_rampcounter_cry_0: Std_logic;
    signal rampcounter_0: Std_logic;
    signal un2_spi_data_11: Std_logic;
    signal un1_rampcounter_1: Std_logic;
    signal interrupt_c: Std_logic;
    signal counter_13: Std_logic;
    signal counter_s_14: Std_logic;
    signal counter_s_13: Std_logic;
    signal counter_cry_12: Std_logic;
    signal counter_12: Std_logic;
    signal counter_11: Std_logic;
    signal counter_s_12: Std_logic;
    signal counter_s_11: Std_logic;
    signal counter_cry_10: Std_logic;
    signal counter_10: Std_logic;
    signal counter_9: Std_logic;
    signal counter_s_10: Std_logic;
    signal counter_s_9: Std_logic;
    signal counter_cry_8: Std_logic;
    signal counter_8: Std_logic;
    signal counter_7: Std_logic;
    signal counter_s_8: Std_logic;
    ...
    signal counter_s_1: Std_logic;
    signal xtal_in_c: Std_logic;
    signal counter2_1: Std_logic;
    signal counter2_0: Std_logic;
    signal adc_clk_copy_c: Std_logic;
    signal counter2_RNO_2: Std_logic;
    signal xtal_in_c_i: Std_logic;
    signal counter2_RNO_1: Std_logic;
    signal counter2_i_0: Std_logic;
    signal counter3_1: Std_logic;
    signal counter3_0: Std_logic;
    signal counter3_RNO_1: Std_logic;
    signal counter3_i_0: Std_logic;
    signal counter3_3: Std_logic;
    signal counter3_2: Std_logic;
    signal counter3_3_3: Std_logic;
    signal counter3_3_2: Std_logic;
    ...
    signal un7_rampcounter_8: Std_logic;
    signal un7_rampcounter_7: Std_logic;
    signal un7_rampcounter_6: Std_logic;
    signal GNDS: Std_logic;
    signal adc_clk_c: Std_logic;
    signal spi_miso_c: Std_logic;
    signal pll1_CLKFB_t: Std_logic;
    signal VCCI: Std_logic;
    component SLICE_0
      port (A1: in Std_logic; DI1: in Std_logic; CLK: in Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    ...
    component spi_data_1_3_SLICE_20
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            M0: in Std_logic; OFX0: out Std_logic);
    end component;
    component spi_data_1_10_SLICE_21
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            M0: in Std_logic; OFX0: out Std_logic);
    end component;
    component spi_data_1_6_SLICE_22
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            M1: in Std_logic; M0: in Std_logic; FXB: in Std_logic; 
            FXA: in Std_logic; OFX0: out Std_logic; OFX1: out Std_logic);
    ...
    component interruptB
      port (PADDO: in Std_logic; interruptS: out Std_logic);
    end component;
    component adc_pdwnB
      port (PADDO: in Std_logic; adcpdwn: out Std_logic);
    end component;
    component adc_clk_copy2B
      port (PADDO: in Std_logic; adcclkcopy2: out Std_logic);
    end component;
    component adc_clk_copyB
      port (PADDO: in Std_logic; adcclkcopy: out Std_logic);
    end component;
    component adc_clkB
      port (PADDO: in Std_logic; adcclk: out Std_logic);
    ...
    component pll1_PLLInst_0
      port (CLKI: in Std_logic; CLKFB: in Std_logic; CLKINTFB: out Std_logic; 
            CLKOP: out Std_logic);
    end component;
  begin
    SLICE_0I: SLICE_0
      port map (A1=>counter_0, DI1=>counter_s_0, CLK=>clock_c, F1=>counter_s_0, 
                Q1=>counter_0, FCO=>counter_cry_0);
    SLICE_1I: SLICE_1
      port map (A0=>rampcounter_11, DI0=>un1_rampcounter_12, 
                LSR=>un7_rampcounter, CLK=>spi_clk_c, 
                FCI=>un1_rampcounter_cry_10, F0=>un1_rampcounter_12, 
                Q0=>rampcounter_11);
    SLICE_2I: SLICE_2
      port map (A1=>rampcounter_10, A0=>rampcounter_9, DI1=>un1_rampcounter_11, 
                DI0=>un1_rampcounter_10, LSR=>un7_rampcounter, CLK=>spi_clk_c, 
                FCI=>un1_rampcounter_cry_8, F0=>un1_rampcounter_10, 
                Q0=>rampcounter_9, F1=>un1_rampcounter_11, Q1=>rampcounter_10, 
                FCO=>un1_rampcounter_cry_10);
    SLICE_3I: SLICE_3
      port map (A1=>rampcounter_8, A0=>rampcounter_7, DI1=>un1_rampcounter_9, 
                DI0=>un1_rampcounter_8, LSR=>un7_rampcounter, CLK=>spi_clk_c, 
                FCI=>un1_rampcounter_cry_6, F0=>un1_rampcounter_8, 
                Q0=>rampcounter_7, F1=>un1_rampcounter_9, Q1=>rampcounter_8, 
                FCO=>un1_rampcounter_cry_8);
    SLICE_4I: SLICE_4
      port map (A1=>rampcounter_6, A0=>rampcounter_5, DI1=>un1_rampcounter_7, 
                DI0=>un1_rampcounter_6, LSR=>un7_rampcounter, CLK=>spi_clk_c, 
                FCI=>un1_rampcounter_cry_4, F0=>un1_rampcounter_6, 
                Q0=>rampcounter_5, F1=>un1_rampcounter_7, Q1=>rampcounter_6, 
                FCO=>un1_rampcounter_cry_6);
    SLICE_5I: SLICE_5
      port map (A1=>rampcounter_4, A0=>rampcounter_3, DI1=>un1_rampcounter_5, 
                DI0=>un1_rampcounter_4, LSR=>un7_rampcounter, CLK=>spi_clk_c, 
                FCI=>un1_rampcounter_cry_2, F0=>un1_rampcounter_4, 
                Q0=>rampcounter_3, F1=>un1_rampcounter_5, Q1=>rampcounter_4, 
                FCO=>un1_rampcounter_cry_4);
    SLICE_6I: SLICE_6
      port map (A1=>rampcounter_2, A0=>rampcounter_1, DI1=>un1_rampcounter_3, 
                DI0=>un1_rampcounter_2, LSR=>un7_rampcounter, CLK=>spi_clk_c, 
                FCI=>un1_rampcounter_cry_0, F0=>un1_rampcounter_2, 
                Q0=>rampcounter_1, F1=>un1_rampcounter_3, Q1=>rampcounter_2, 
                FCO=>un1_rampcounter_cry_2);
    SLICE_7I: SLICE_7
      port map (A1=>rampcounter_0, B0=>un2_spi_data_11, DI1=>un1_rampcounter_1, 
                LSR=>un7_rampcounter, CLK=>spi_clk_c, F1=>un1_rampcounter_1, 
                Q1=>rampcounter_0, FCO=>un1_rampcounter_cry_0);
    SLICE_8I: SLICE_8
      port map (A1=>interrupt_c, A0=>counter_13, DI1=>counter_s_14, 
                DI0=>counter_s_13, CLK=>clock_c, FCI=>counter_cry_12, 
                F0=>counter_s_13, Q0=>counter_13, F1=>counter_s_14, 
                Q1=>interrupt_c);
    SLICE_9I: SLICE_9
      port map (A1=>counter_12, A0=>counter_11, DI1=>counter_s_12, 
                DI0=>counter_s_11, CLK=>clock_c, FCI=>counter_cry_10, 
                F0=>counter_s_11, Q0=>counter_11, F1=>counter_s_12, 
                Q1=>counter_12, FCO=>counter_cry_12);
    SLICE_10I: SLICE_10
      port map (A1=>counter_10, A0=>counter_9, DI1=>counter_s_10, 
                DI0=>counter_s_9, CLK=>clock_c, FCI=>counter_cry_8, 
                F0=>counter_s_9, Q0=>counter_9, F1=>counter_s_10, 
                Q1=>counter_10, FCO=>counter_cry_10);
    SLICE_11I: SLICE_11
      port map (A1=>counter_8, A0=>counter_7, DI1=>counter_s_8, 
                DI0=>counter_s_7, CLK=>clock_c, FCI=>counter_cry_6, 
                F0=>counter_s_7, Q0=>counter_7, F1=>counter_s_8, Q1=>counter_8, 
                FCO=>counter_cry_8);
    SLICE_12I: SLICE_12
      port map (A1=>counter_6, A0=>counter_5, DI1=>counter_s_6, 
                DI0=>counter_s_5, CLK=>clock_c, FCI=>counter_cry_4, 
                F0=>counter_s_5, Q0=>counter_5, F1=>counter_s_6, Q1=>counter_6, 
                FCO=>counter_cry_6);
    SLICE_13I: SLICE_13
      port map (A1=>counter_4, A0=>counter_3, DI1=>counter_s_4, 
                DI0=>counter_s_3, CLK=>clock_c, FCI=>counter_cry_2, 
                F0=>counter_s_3, Q0=>counter_3, F1=>counter_s_4, Q1=>counter_4, 
                FCO=>counter_cry_4);
    SLICE_14I: SLICE_14
      port map (A1=>counter_2, A0=>counter_1, DI1=>counter_s_2, 
                DI0=>counter_s_1, CLK=>clock_c, FCI=>counter_cry_0, 
                F0=>counter_s_1, Q0=>counter_1, F1=>counter_s_2, Q1=>counter_2, 
                FCO=>counter_cry_2);
    SLICE_15I: SLICE_15
      port map (A1=>xtal_in_c, C0=>counter2_1, B0=>counter2_0, 
                A0=>adc_clk_copy_c, DI0=>counter2_RNO_2, CLK=>clock_c, 
                F0=>counter2_RNO_2, Q0=>adc_clk_copy_c, F1=>xtal_in_c_i);
    SLICE_16I: SLICE_16
      port map (B1=>counter2_1, A1=>counter2_0, A0=>counter2_0, 
                DI1=>counter2_RNO_1, DI0=>counter2_i_0, CLK=>clock_c, 
                F0=>counter2_i_0, Q0=>counter2_0, F1=>counter2_RNO_1, 
                Q1=>counter2_1);
    SLICE_17I: SLICE_17
      port map (B1=>counter3_1, A1=>counter3_0, A0=>counter3_0, 
                DI1=>counter3_RNO_1, DI0=>counter3_i_0, CLK=>spi_clk_c, 
                F0=>counter3_i_0, Q0=>counter3_0, F1=>counter3_RNO_1, 
                Q1=>counter3_1);
    SLICE_18I: SLICE_18
      port map (D1=>counter3_3, C1=>counter3_2, B1=>counter3_1, A1=>counter3_0, 
                D0=>counter3_3, C0=>counter3_2, B0=>counter3_1, A0=>counter3_0, 
                DI1=>counter3_3_3, DI0=>counter3_3_2, CLK=>spi_clk_c, 
                F0=>counter3_3_2, Q0=>counter3_2, F1=>counter3_3_3, 
                Q1=>counter3_3);
    SLICE_19I: SLICE_19
      port map (D1=>counter3_3, C1=>counter3_2, B1=>counter3_1, A1=>counter3_0, 
                C0=>counter3_2, B0=>N_18, A0=>N_15, DI0=>spi_data_1, 
                CLK=>spi_clk_c, F0=>spi_data_1, Q0=>spi_data, 
                F1=>un2_spi_data_11);
    spi_data_1_3_SLICE_20I: spi_data_1_3_SLICE_20
      port map (C1=>rampcounter_10, B1=>rampcounter_2, A1=>counter3_3, 
                C0=>rampcounter_8, B0=>rampcounter_0, A0=>counter3_3, 
                M0=>counter3_1, OFX0=>N_11);
    spi_data_1_10_SLICE_21I: spi_data_1_10_SLICE_21
      port map (C1=>rampcounter_7, B1=>rampcounter_5, A1=>counter3_1, 
                C0=>rampcounter_6, B0=>rampcounter_4, A0=>counter3_1, 
                M0=>counter3_0, OFX0=>N_18);
    spi_data_1_6_SLICE_22I: spi_data_1_6_SLICE_22
      port map (C1=>rampcounter_11, B1=>rampcounter_3, A1=>counter3_3, 
                C0=>rampcounter_9, B0=>rampcounter_1, A0=>counter3_3, 
                M1=>counter3_0, M0=>counter3_1, FXB=>N_14, FXA=>N_11, 
                OFX0=>N_14, OFX1=>N_15);
    SLICE_23I: SLICE_23
      port map (D1=>rampcounter_7, C1=>rampcounter_6, B1=>rampcounter_5, 
                A1=>rampcounter_4, C0=>un7_rampcounter_8, 
                B0=>un7_rampcounter_7, A0=>un7_rampcounter_6, 
                F0=>un7_rampcounter, F1=>un7_rampcounter_8);
    SLICE_24I: SLICE_24
      port map (D1=>rampcounter_11, C1=>rampcounter_10, B1=>rampcounter_9, 
                A1=>rampcounter_8, D0=>rampcounter_3, C0=>rampcounter_2, 
                B0=>rampcounter_1, A0=>rampcounter_0, F0=>un7_rampcounter_7, 
                F1=>un7_rampcounter_6);
    SLICE_25I: SLICE_25
      port map (F0=>GNDS);
    xtal_outI: xtal_outB
      port map (PADDO=>xtal_in_c_i, xtalout=>xtal_out);
    clockI: clockB
      port map (PADDI=>clock_c, clockS=>clock);
    interruptI: interruptB
      port map (PADDO=>interrupt_c, interruptS=>interrupt);
    adc_pdwnI: adc_pdwnB
      port map (PADDO=>GNDS, adcpdwn=>adc_pdwn);
    adc_clk_copy2I: adc_clk_copy2B
      port map (PADDO=>adc_clk_c, adcclkcopy2=>adc_clk_copy2);
    adc_clk_copyI: adc_clk_copyB
      port map (PADDO=>adc_clk_copy_c, adcclkcopy=>adc_clk_copy);
    adc_clkI: adc_clkB
      port map (PADDO=>adc_clk_c, adcclk=>adc_clk);
    spi_misoI: spi_misoB
      port map (IOLDO=>spi_miso_c, spimiso=>spi_miso);
    spi_miso_MGIOLI: spi_miso_MGIOL
      port map (IOLDO=>spi_miso_c, OPOS=>spi_data, CLK=>spi_clk_c);
    spi_clkI: spi_clkB
      port map (PADDI=>spi_clk_c, spiclk=>spi_clk);
    xtal_inI: xtal_inB
      port map (PADDI=>xtal_in_c, xtalin=>xtal_in);
    pll1_PLLInst_0I: pll1_PLLInst_0
      port map (CLKI=>clock_c, CLKFB=>pll1_CLKFB_t, CLKINTFB=>pll1_CLKFB_t, 
                CLKOP=>adc_clk_c);
    VHI_INST: VHI
      port map (Z=>VCCI);
    PUR_INST: PUR
  ...
  library IEEE, vital2000, MACHXO3L;
  configuration Structure_CON of test_togglepins is
    for Structure
    end for;
  end Structure_CON;
