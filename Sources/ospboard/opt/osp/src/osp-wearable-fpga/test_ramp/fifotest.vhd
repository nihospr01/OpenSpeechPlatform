...
-- Module  Version: 5.8
--/usr/local/diamond/3.10_x64/ispfpga/bin/lin64/scuba -w -n fifotest -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo3c00f -type ebfifo -depth 8192 -width 12 -rwidth 12 -no_enable -pe 10 -pf 508 

-- Wed Nov 28 17:02:56 2018
...
architecture Structure of fifotest is
...
begin
    ...
    fifotest_0_11: FIFO8KB
        generic map (FULLPOINTER1=> "0b01111111111111", FULLPOINTER=> "0b10000000000000", 
        AFPOINTER1=> "0b00000111111011", AFPOINTER=> "0b00000111111100", 
...
-- synopsys translate_off
library MACHXO3L;
configuration Structure_CON of fifotest is
    for Structure
