...
-- Module  Version: 5.7
--/usr/local/diamond/3.10_x64/ispfpga/bin/lin64/scuba -w -n plltest -lang vhdl -synth synplify -arch xo3c00f -type pll -fin 12.8 -mdiv 1 -ndiv 1 -bypassp -bypass_divp -adiv 8 -phase_cntl STATIC -fb_mode 5 
...
architecture Structure of plltest is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "1.600000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "12.800000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  7, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  8, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
...
-- synopsys translate_off
library MACHXO3L;
configuration Structure_CON of plltest is
    for Structure
