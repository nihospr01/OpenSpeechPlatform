...
class noise_management {
  ...
  public:
     ...
     * @param[in] ntype The type of noise estimation, 1: using limits on change (ref: Arslan et al.), 2: using the
     * weighted averaging of Hirsch and Ehrlicher, 3: using MCRA of Cohen and Berdugo
     ...
     */
    void speech_enhancement(float *data_in, uint in_len, float *data_out);
