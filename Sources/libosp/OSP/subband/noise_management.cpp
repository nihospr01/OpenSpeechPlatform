...
void noise_management::set_param(int ntype, int stype, float sparam) {
...
void noise_management::get_param(int &ntype, int &stype, float &sparam) {
...
void noise_management::speech_enhancement(float *data_in, uint in_len, float *data_out) {
    float xpow[in_len];
    float npow[in_len];
    float vpow[in_len];
    float peak[in_len];
