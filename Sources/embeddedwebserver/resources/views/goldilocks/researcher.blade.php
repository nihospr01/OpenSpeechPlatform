...
<body>
    ...
    <div class="container">
        <div>
            <a class="btn btn-info btn-sm" href="{{ url('/goldilocks/researcher/login') }}" role="button" style="margin-top: 5px">Back</a>
        </div>
        ...
        <div class="row" id="param_table" style="background-color: #91f2ad;">
            <div class="col-12">
                <table class="table table-striped table-bordered table-sm" style="border-color: white;border-collapse:collapse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th class="text-center" style="font-size: 1.2rem; border-color: white">G50 Max</th>
                            ...
                            <td style="border-color: white; border-width: thick"><input style="color: black; font-size: 1.2rem" name="g50_max" data-index="6" id="g50_max_all" class="form-conftrol form-control-sm table-field font-weight-bold" type="number" step="0.1" value=""></td>
                        </tr>
                        <tr>
                            <th class="text-center" style="font-size: 1.2rem; border-color: white">G80 Min</th>
                            <td style="border-color: white; border-width: thick"><input style="color: black; font-size: 1.2rem" name="g80_min" data-index="0" id="g80_min_0" class="form-control form-control-sm table-field font-weight-bold" type="number" step="0.1" value="35"></td>
                            <td style="border-color: white; border-width: thick"><input style="color: black; font-size: 1.2rem" name="g80_min" data-index="1" id="g80_min_1" class="form-control form-control-sm table-field font-weight-bold" type="number" step="0.1" value="35"></td>
                            <td style="border-color: white; border-width: thick"><input style="color: black; font-size: 1.2rem" name="g80_min" data-index="2" id="g80_min_2" class="form-control form-control-sm table-field font-weight-bold" type="number" step="0.1" value="35"></td>
                            <td style="border-color: white; border-width: thick"><input style="color: black; font-size: 1.2rem" name="g80_min" data-index="3" id="g80_min_3" class="form-control form-control-sm table-field font-weight-bold" type="number" step="0.1" value="35"></td>
                            <td style="border-color: white; border-width: thick"><input style="color: black; font-size: 1.2rem" name="g80_min" data-index="4" id="g80_min_4" class="form-control form-control-sm table-field font-weight-bold" type="number" step="0.1" value="35"></td>
                            <td style="border-color: white; border-width: thick"><input style="color: black; font-size: 1.2rem" name="g80_min" data-index="5" id="g80_min_5" class="form-control form-control-sm table-field font-weight-bold" type="number" step="0.1" value="35"></td>
                            <td style="border-color: white; border-width: thick"><input style="color: black; font-size: 1.2rem" name="g80_min" data-index="6" id="g80_min_all" class="form-control form-control-sm table-field font-weight-bold" type="number" step="0.1" value=""></td>
                        </tr>
                        <tr>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input id="modalInput" name="programName" type="text" placeholder="Quiet, Noisy, etc." autocomplete="off">
    ...
    <script language="JavaScript">
        ...
        var twoChannelParams = ['targets', 'ltass', 'hearing_loss', 'compression_ratio', 'g50', 'g65', 'g80', 'g50_max', 'g80_min', 'knee_low', 'mpo_band', 'attack', 'release'];
        ...
        function prefillParameters() {
            ...
            Object.keys(parameters).forEach((key, index) => {
                this['parameters'][key] = JSON.parse(JSON.stringify(generic[key]));
            })
            Object.keys(parametersTwoChannels['left']).forEach((key, index) => {
                this['parametersTwoChannels']['left'][key] = JSON.parse(JSON.stringify(generic[key]));
            })

            Object.keys(parametersTwoChannels['right']).forEach((key, index) => {
                this['parametersTwoChannels']['right'][key] = JSON.parse(JSON.stringify(generic[key]));
            })
        ...
        function updateParameters() {
            for (var i = 0; i < 6; i++) {
                ...
                document.getElementById("g80_min_" + i).value = fixPrecision(parametersTwoChannels[channels[0]]['g80_min'][i]);
            ...
            document.getElementById("g80_min_all").value = "";
