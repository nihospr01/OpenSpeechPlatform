...
<div class= "container-fluid back"style="background-color: #e8ecf1;" >
  <div class="row">
    ...
    <div class= "row">
      ...
      <div class="footer" style="background-color: transparent; margin: auto; width: 80%">
        <a class="btn btn-info btn-sm" style = "float: left; margin-top: 20px"
        href="{{url('/goldilocks')}}" role="button" >Back</a>

        <form style="display: inline-block" method="POST" onsubmit="return validateForm()">
            {{ Form::token() }}
