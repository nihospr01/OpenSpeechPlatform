...
<body>
    ...
    <div class="container">
        ...
        <div class="list-group">
            ...
            <a href="{{ url('/goldilocks/listener/login') }}" class="list-group-item list-group-item-action">Self Adjustment</a>
            <a href="{{ url('/goldilocks/logs') }}" class="list-group-item list-group-item-action">Download Logs</a>
        </div>

        <div class="row" style="margin-top: 15px">
            <div class="col-sm-8" id = "home" >
                <a class="btn btn-info btn-sm" href="{{url('/')}}" role="button" >Back</a>
            </div>
