...
<body style="background-color: #e8ecf1;">
    ...
    <div class="container-fluid" style="background-color: #e8ecf1">
        ...
        <div id="crispness_section" class="container" style="background-color: #f4d03f; padding: 1rem; visibility: hidden;">
            ...
            <div class="row" style="height:33%">
                <div class= "col-4 text-center">
                    <button id="h_less"  type="button" class="btn-anim leftBtn">
                        Less
                    </button>
                </div>
                ...
                <div class="col-4 text-center">
                    <button id="h_more"  type="button" class="btn-anim rightBtn">
                        More
                    </button>
                </div>
            </div>
        ...
        <div id="loudness_section" class="container" style= "background-color: #6bb9f0; padding:1rem; visibility: hidden;" >
            ...
            <div class= "row" style="height:33%">
                <div class="col-4 text-center">
                    <button id="v_less"  type="button" class="btn-anim leftBtn">
                        Less
                    </button>
                </div>
                <div class="col-4 text-center">
                ...
                <div class="col-4 text-center">
                    <button id="v_more"  type="button" class="btn-anim rightBtn">
                        More
                    </button>
                </div>
            </div>
        ...
        <div id="fullness_section" class="container" style= "background-color: #fabe58; padding:1rem; visibility: hidden;">
            ...
            <div class="row" style="height:33%">
                <div class="col-4 text-center">
                    <button id="l_less"  type="button" class="btn-anim leftBtn">
                        Less
                    </button>
                </div>
                <div class="col-4 text-center">
                ...
                <div class="col-4 text-center">
                    <button id="l_more"  type="button" class="btn-anim rightBtn">
                        More
                    </button>
                </div>
            </div>
        ...
        <div>
            ...
            href="{{url('/goldilocks')}}" role="button" >Back</a>
        </div>
    </div>
    ...
    <script language="JavaScript">
        ...
        /**
         * Returns true if change would exceed minimum for one channel
         */
        function exceedsMin(l_val, v_val, h_val){
            for(i = 0; i < 6; i++){
                //loop through two channels of starting_g65 and cr
                for(j = 0; j < 2; j++){
                    var g65 = this['starting_g65'][j][i] + v_val + (l_val * this['parametersSingleChannel']['multiplier_l'][i]) + (h_val * this['parametersSingleChannel']['multiplier_h'][i]);
                    ...
                    if(cr != 0){
                        var slope = (1 - cr) / cr;
                        var g80 = g65 + (slope * 15);
                        if(g80 < this['parametersTwoChannels'][channels[j]]['g80_min'][i]){
                            return true;
                        }
                    }
                    else{
        ...
        function enableButtonOnBypassMinOvershoot() {
            ...
            if(new_value_l >= this['parametersSingleChannel']['l_min']){
                var new_value_l_2 = old_value_l - sub_l;
            ...
            if(new_value_v >= this['parametersSingleChannel']['v_min']){
                ...
                if(!exceedsMin(l_val, v_val, h_val)){
                    ...
                    v_less.style.color = "black";
                }
            }

            if(new_value_h >= this['parametersSingleChannel']['h_min']){
                var new_value_h_2 = old_value_h - sub_h;
