    ...
    <div class="container">
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <th scope="col">Currently Active Listener</th>
            </tr>
            </thead>
            <tbody>
            @foreach($listeners as $listener)
                <tr>
                    ...
                    <td>
                        <form method="post" action="/goldilocks/admin/selectListener">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <input type="hidden" name="listener_id" value="{{ $listener->id }}">
                            @if ($listener->mostRecent)
                                <input type="radio" name="selectListener" checked="checked">
                            @else
                                <input type="radio" name="selectListener">
                            @endif
        ...
        <div>
            <a class="btn btn-info btn-sm" href="{{ url('/goldilocks/admin') }}" role="button" style="margin-top: 10px">Back</a>
        </div>
    ...
    <div class="modal fade" id="newListenerModal" tabindex="-1" role="dialog" aria-labelledby="New Listener" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                {{ Form::open(['url' => '/goldilocks/admin/listeners', 'method' => 'POST', 'autocomplete' => 'off']) }}
