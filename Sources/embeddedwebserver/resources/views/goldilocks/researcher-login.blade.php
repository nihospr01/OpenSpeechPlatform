            ...
            <div class="col-12">
                ...
                <form class="form-horizontal" method="POST">
                    ...
                    <div class="form-inline">
                        ...
                        <div class="col-sm-8">
                            @if(!$curResearcher)
                                <input type="text" class="text_1" id="researcher" name="researcher" placeholder="Researcher" autocomplete="off">
                            @else
                                <input type="text" class="text_1" id="researcher" name="researcher" value="{{ $curResearcher->researcher }}" autocomplete="off">
                            @endif
                         </div>
                    </div>
