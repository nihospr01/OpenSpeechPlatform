...
<body>
    ...
    <div class="container">
        <div>
            <a class="btn btn-info btn-sm" href="{{ url('/') }}" role="button" style="margin-top: 10px">Back</a>
        </div>
        <div class="row align-items-center">
            ...
            <div class="col-6">
                ...
                <div class="row align-items-center" style="margin: 1px">
                    <button type="button" class="btn btn-info btn-block" onclick="deleteCurrentCalibration()">Delete Current Calibration</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input id="modalInput" name="calibrationName" type="text" placeholder="" autocomplete="off">
    ...
    <script language="JavaScript">
        ...
        $(document).ready(function(){
            alert("Channel is set to: " + channel);
        });
        ...
        // Delete the currently selected calibration
        function deleteCurrentCalibration() {
            console.log("Attempting to delete current calibration");
            if (!window.confirm("Are you sure you want to delete the current calibration")) {
                return false;
            }
            var id = this["selectedCalibration"];
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log(response);
                    console.log('success');
                    alert("Current calibration successfully deleted");
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                    console.log(JSON.stringify(jqXHR));
                    console.log("AJAX error: " + textStatus + ' : ' + errorThrown);
                    alert("[ERROR] deleteCurrentCalibration(): " + errorThrown);
                }
            });
        }
    </script>
