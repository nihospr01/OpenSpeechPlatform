...
Route::resource('/goldilocks/admin/listeners', 'Goldilocks\GoldilocksListenerController',
                ['only' => ['index', 'store', 'destroy']]);
Route::post('goldilocks/admin/selectListener', 'Goldilocks\GoldilocksListenerController@selectListener');
...
Route::middleware(['auth.listener'])->group(function() {
...
Route::post('/calibration/delete', 'CalibrationController@delete');